...
export class PortfolioComponent implements OnInit {
  ...
  csharp = [
    {"id": 2001, "name": "Movie MVC","url":"https://jarnonmovieapp.azurewebsites.net/Movies", "update": "päivitetty: 26.4.2023", "detail": "Ohjelma tallentaa Azure SQL palvelimelle annetut tiedot (CRUD). Azure SQL palvelimeen otetaan yhteys rajapinnalla ja rajapintaa voi lukea esim Asp.NET, Angularilla tai vastaavalla frontendillä. Julkaistu käyttäen Azure pipelines","status":"valmis"},
    {"id": 2002, "name": "Moviestore","url":"https://jarnomovies.azurewebsites.net/", "update": "päivitetty: 15.4.2023", "detail": "Ohjelma lukee ylläolevan MVC Movien rajapinnasta dataa ja antaa ns. käyttäjänäkymän erikseen määritetyistä kentistä. Voit testata toimintaa lisäämällä/poistamalla MVC Movies -ohjelmaan dataa. Julkaistu käyttäen Azure pipelines.","status":"valmis"},
