...
export class PortfolioComponent implements OnInit {
  ...
  programs = [
    ...
    {"id": 1002, "name": "Citybike Helsinki","url":"https://solitacitybike.azurewebsites.net", "update": "päivitetty: 9.3.2024", "detail": "Solitan citybike ohjelma, jossa mahdollisuutena katsoa asemia, matkoja, lisätä, poistaa ja muokata näitä. Tehty Solitan Devacademyn tehtävänannosta demoprojektina. Tietokantana taustalla Azure SQL, ohjelmoitu Angularilla ja C#:lla.","status":"valmis"},
    {"id": 1003, "name": "Blogs","url":"https://blogapp2024.onrender.com/", "update": "päivitetty: 9.3.2024", "detail": "Blogi, jossa mahdollisuus kirjautua sisään ja kirjoittaa blogitekstiä. Teksti tallentuu tietokantaan ja näkyy kaikille käyttäjille. Oma sivu, johon voi tallentaa blogeja. Tietokantana taustalla Azure SQL, ohjelmoitu kokonaan Reactilla.","status":"valmis"},
    {"id": 1004, "name": "Helsinki Linked Events","url":"https://linkedevents.azurewebsites.net", "update": "päivitetty: 9.3.2024", "detail": "Webpohjainen selain, joka hakee Helsingin kaupungin Linked Events rajapinnasta datan ohjelmaan. Ohjelmoitu Angularilla.","status":"valmis"},
    ...
    {"id": 1009, "name": "Pizzeria Pasila","url":"https://pizza-pasila.web.app", "update": "päivitetty: 9.3.2024", "detail": "FreeCodeCampin kautta verkkokaupan pohja, jossa tuotteet ja ostoskori. Ohjelmoitu Angularilla.","status":"valmis"},
  ]
