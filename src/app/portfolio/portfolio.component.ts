...
export class PortfolioComponent implements OnInit {
  ...
  programs: Project[] = [
    ...
    {"id": 1009, "name": "Ulkopelit", "url":"https://ulkopelit.onrender.com", "update": "01.03.2025", "detail": "Reactilla ja Vitellä ohjelmoitu webapp, jossa pelaaja voi ilmoittautua ulkopeleihin.","status":"valmis", "image": "../../assets/images/ULKOPELIT.WEBP", "githubRepo": "Ulkopelit"},
  ];
